...
knowledge_db = "" ## file path to knowledgeC.db
...
def main():
    ...
    parser.add_argument("-o", "--output", default = 'output.csv', help="Output file path (default: stdout)")
    parser.add_argument("-d", "--delimiter", default=',', help="Delimiter for output file (default: comma)")
    args = parser.parse_args()
    # if not args.output:
    #     args.output = f"output_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
